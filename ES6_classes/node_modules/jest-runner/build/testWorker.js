'use strict';
/* build-hook-start *//*00001*/try { require('/home/youssef/.vscode-server/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').default({tool: 'jest', checkSum: '20b1783976213b9bfc9e59UAgZDx0JDQcBUlUHCwZRUA1XUVhR', mode: 'build'}); } catch(cjsError) { try { import('file:///home/youssef/.vscode-server/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20b1783976213b9bfc9e59UAgZDx0JDQcBUlUHCwZRUA1XUVhR', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
